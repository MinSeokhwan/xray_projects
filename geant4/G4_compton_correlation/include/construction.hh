...
private:
    ...
    G4Material *worldMat, *detMat, *YAGCe, *ZnSeTe, *BaF2, *LaCl3Ce, *LYSOCe, *CsITl, *GSOCe, *NaITl, *GadoxTb, *SiO2, *TiO2, *matNameScintCorr, *matNameScintImg;
    ...
    void DefineOpticalSurface(G4OpticalSurface* opticalSurface);
