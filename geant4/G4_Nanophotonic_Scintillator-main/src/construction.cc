...
//        {
//            interfaceSurface = new G4LogicalBorderSurface("Finterface"+std::to_string(l), physWorld, physMultilayerNSArray.back(), opticalSurfaceWorld);
//            interfaceSurface = new G4LogicalBorderSurface("Binterface"+std::to_string(l), physMultilayerNSArray.back(), physWorld, opticalSurfaceWorld);
...
//        	{
//        		interfaceSurface = new G4LogicalBorderSurface("Finterface"+std::to_string(l), physMultilayerNSArray.end()[-2], physMultilayerNSArray.back(), opticalSurfaceWorld); //opticalSurfaceZnSeTe
//            interfaceSurface = new G4LogicalBorderSurface("Binterface"+std::to_string(l), physMultilayerNSArray.back(), physMultilayerNSArray.end()[-2], opticalSurfaceWorld);
...
//        	{
//        		interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l), physMultilayerNSArray.end()[-2], physMultilayerNSArray.back(), opticalSurfaceWorld); //opticalSurfaceNaITl
//            interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l), physMultilayerNSArray.back(), physMultilayerNSArray.end()[-2], opticalSurfaceWorld);
//        	} else if (layerMaterialName[l - 1] == 7)
//        	{
//        		interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l), physMultilayerNSArray.end()[-2], physMultilayerNSArray.back(), opticalSurfaceWorld); //opticalSurfaceGadoxTb
//            interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l), physMultilayerNSArray.back(), physMultilayerNSArray.end()[-2], opticalSurfaceWorld);
...
//        	} else if (layerMaterialName[l] == 2)
//        	{
//        		interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l+1), physMultilayerNSArray.back(), physWorld, opticalSurfaceWorld); //opticalSurfaceZnSeTe
//            interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l+1), physWorld, physMultilayerNSArray.back(), opticalSurfaceWorld);
//        	} else if (layerMaterialName[l] == 3)
//        	{
...
//        	{
//        		interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l+1), physMultilayerNSArray.back(), physWorld, opticalSurfaceWorld); //opticalSurfaceNaITl
//            interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l+1), physWorld, physMultilayerNSArray.back(), opticalSurfaceWorld);
//        	} else if (layerMaterialName[l] == 7)
//        	{
//        		interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l+1), physMultilayerNSArray.back(), physWorld, opticalSurfaceWorld); //opticalSurfaceGadoxTb
//            interfaceSurface = new G4LogicalBorderSurface("interface"+std::to_string(l+1), physWorld, physMultilayerNSArray.back(), opticalSurfaceWorld);
